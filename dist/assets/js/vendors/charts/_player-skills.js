...
myChart.showLoading();
var titleName, valdata, PlayerData, datas, playerImage, clubImage, countryImage, datalen;
...
$.get("./assets/data/player-skills.json", function (data) {
	...
	$(".player-card").css("background", "linear-gradient(110deg, " + datas.ColorOne + " 60%, " + datas.ColorTwo + " 60%)");
	$(".card-wrapper").css("background", "linear-gradient(70deg, " + datas.ColorTwo + "  30%, rgba(0,0,0,0) 30%), linear-gradient(30deg, " + datas.ColorThree + " 60%, " + datas.ColorOne + " 60%)");
