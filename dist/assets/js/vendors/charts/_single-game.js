...
function GetPlayers(id) {
  $.get("./assets/data/single-game.json", function (response) {
    ...
    for (var i = 0; i < evts.length; i++) {
      ...
      if (evts[i].type == "Yellow Card") symbol = "yellowcard";else if (evts[i].type == "Goal") symbol = "soccer";else if (evts[i].type == "VAR") symbol = "Monitor";else if (evts[i].type == "Penalty") symbol = "goal";else if (evts[i].type == "Red Card") symbol = "redcard";else if (evts[i].type == "Double Yellow Card") symbol = "cards";else if (evts[i].type == "Subsition") symbol = "subs";
      lineData.push({
        coords: [[lineDataOffset1, evts[i].minute], [lineDataOffset2, evts[i].minute + lineDataYOffset]],
        value: evts[i].minute,
        name: evts[i].type,
        ...
        label: {
          ...
          formatter: function formatter(value) {
            ...
            return " {name|" + value.data.minute + '"' + "} {logo|} {name| " + value.data.pname + subsName + "} ";
          }
        }
      });
      SeriesData.push({
