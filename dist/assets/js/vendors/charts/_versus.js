...
GetVersus(localStorage.getItem('player1'), localStorage.getItem('player2'), localStorage.getItem('pvColor'), localStorage.getItem('pvBg'));
myChart.showLoading();
...
$('.ui.dropdown.bg').dropdown({
	onChange: function onChange(value) {
		localStorage.setItem('pvBg', value);
		GetVersus(localStorage.getItem('player1'), localStorage.getItem('player2'), localStorage.getItem('pvColor'), value);
	}
